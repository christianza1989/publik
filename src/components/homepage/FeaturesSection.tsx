    ...
    <AnimatedSection id="features" className="py-20 sm:py-28 bg-gray-50 dark:bg-slate-900">
      <div className="container mx-auto px-4">
        ...
        <div className="w-full max-w-4xl mx-auto">
          {/* Mobile View - Interactive Card */}
          {/* <<< PRADĖTI KEISTI NUO ČIA >>> */}
          <div className="md:hidden w-full flex flex-col items-center" style={{ perspective: '1000px' }}>

              {/* Konteineris, skirtas TIK kortelės aukščio animacijai */}
              <motion.div
                  className="w-full max-w-sm"
                  animate={{ height: cardHeight || 'auto' }}
                  transition={{ duration: 0.4, ease: "easeInOut" }}
              >
                  {/* Konteineris, skirtas TIK slinkimo gestui */}
                  <motion.div
                      drag="x"
                  ...
                  >
                      {/* Konteineris, skirtas TIK 3D apsivertimo animacijai */}
                      <motion.div
                      ...
                      >
                          {/* Priekinė pusė (Senas būdas) */}
                          <div ref={frontCardRef} className="absolute w-full h-auto" style={{ backfaceVisibility: 'hidden' }}>
                              <Card className="dark:bg-slate-800/50 dark:backdrop-blur-sm shadow-lg h-full">
                                  <CardHeader>
              ...
              {/* Slinkimo Indikatorius (po kortelės bloku) */}
              <motion.div
                  initial={{ opacity: 0 }}
                  ...
                  className="text-sm text-muted-foreground mt-6" // Pridėtas didesnis tarpas mt-6
              >
                  Slinkite kortelę
              </motion.div>

              {/* Perjungimo Mygtukai (po kortelės bloku) */}
